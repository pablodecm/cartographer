...
copyright = u'2016, Pablo de Castro'
...
#
# html_title = u'cartographer v0.1.dev0'
...
# the docs.  This file should be a Windows icon (.ico) being 16x16 or 32x32
# pixels large.
#
# html_favicon = None
...
latex_documents = [
    (master_doc, 'cartographer.tex', u'cartographer Documentation',
     u'Pablo de Castro', 'manual'),
]
...
man_pages = [
    (master_doc, 'cartographer', u'cartographer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cartographer', u'cartographer Documentation',
     author, 'cartographer', 'One line description of project.',
     'Miscellaneous'),
]
